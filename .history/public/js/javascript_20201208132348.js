...
rel = "stylesheet" >
    <
    link href = "{{ secure_asset('css/style.css')}}"
rel = "stylesheet" / >
    <
    script src = "{{ secure_asset('js/javascript.js')}}"
defer > < /script>
...
.col - 2 {
    width: -webkit - calc((100 % -60 px) / 2);
    width: -moz - calc((100 % -60 px) / 2);
    width: calc((100 % -60 px) / 2);
}

@media(max - width: 867 px) {
    .col - 2 {
        width: 100 % ;
    }
}
...
.btn {
    ...
    o - transition: all 0.4 s ease; -
    moz - transition: all 0.4 s ease;
...
.select2 - container--open.select2 - dropdown--below {
    ...
    moz - border - radius: 3 px;
    border - radius: 3 px; -
    webkit - box - shadow: 0 px 8 px 20 px 0 px rgba(0, 0, 0, 0.15); -
    moz - box - shadow: 0 px 8 px 20 px 0 px rgba(0, 0, 0, 0.15);
    box - shadow: 0 px 8 px 20 px 0 px rgba(0, 0, 0, 0.15);
...
.card::-webkit - scrollbar - track {
    box - shadow: inset 0 0 6 px rgba(145, 144, 144, 0.767);
}

.card::-webkit - scrollbar - thumb {
    background - color: rgba(153, 139, 139, 0.555);
    outline: 1 px solid rgb(55, 113, 170);
}
...
# preview {
        ...
        height: 30 px;
        font - size: 20 px;
        transform: translate(290 px, -10 px);
        position: absolute;
        z - index: 1;
    }
    ...
    input: focus {
        ...
        min - height: 100 vh;
        background: #c850c0;
        background: -webkit - linear - gradient(45 deg, #4158d0, # c850c0);
        background: -o - linear - gradient(45 deg, #4158d0, # c850c0);
        background: -moz - linear - gradient(45 deg, #4158d0, # c850c0);
        background: linear - gradient(45 deg, #4158d0, # c850c0);
        display: -webkit - box;
        display: -webkit - flex;
        display: -moz - box;
        display: -ms - flexbox;
...
.table100-head th {
    ...
    #input {
        ...
        font - weight: 400;
        color: rgb(65, 60, 60);
        margin: 0 px 0 px 30 px 0 px;
    }

        .row - example {
        margin: 20 px 0 px 20 px 10 px;
    }
    ...
    id = "page-wrapper bg-blue p-t-100 p-b-100 font-robo" >
    <
    ...
    class = "input-group" >
    <
    input id = "input--style-1"
    class = "input--style-1 name"
    ...
    <
    input id = "input--style-1"
    class = "input--style-1 work-number"
    type = "text"
    ...
    <
    input id = "input--style-1"
    class = "input--style-1 home-number"
    type = "text"
    id = "home-number"
    ...
    option id = "default"
    name = "Select"
    value = "Please Select" > Select Branch <
    /option>

    <
    optgroup label = "Gauteng" >
    <
    option name = "Church Street"
    value = "Church Street" > Church Street <
    /option> <
    option name = "Hammanskraal"
    value = "Hammanskraal" > Hammanskraal < /option> <
    option name = "Krugersdorp"
    value = "Krugersdorp" > Krugersdorp < /option> <
    option name = "Kya Sands"
    value = "Kya Sands" > Kya Sands < /option> <
    option name = "Johannesburg"
    value = "Johannesburg" > Johannesburg < /option> <
    option name = "Silverton"
    value = "Silverton" > Silverton < /option> <
    option id = "Soweto"
    name = "Soweto"
    value = "Soweto" > Soweto < /option> <
    option name = "Springs"
    value = "Springs" > Springs < /option> <
    option name = "Sunderland"
    value = "Sunderland" > Sunderland < /option> <
    option name = "Tembisa"
    value = "Tembisa" > Tembisa < /option> <
    option name = "Vanderbijlpark"
    value = "Vanderbijlpark" > Vanderbijlpark <
    /option> <
    option name = "Waltloo"
    value = "Waltloo" > Waltloo < /option> <
    option name = "Wynberg"
    value = "Wynberg" > Wynberg < /option> <
    /optgroup> <
    ...
    <
    p class = "available"
    id = "available" > See available board color previews below. < /p>
    ...
    /option> <
    option value = "1" > 0.4 * 20 mm Basalt Textured finish solid <
    /option> <
    option value = "2" > 1 * 20 mm Basalt Textured finish solid <
    /option> <
    option value = "3" > 0.4 * 20 mm Natural Concrete Textured finish wood <
    /option> <
    option value = "4" > 1 * 20 mm Natural Concrete Textured finish wood <
    /option> <
    option value = "5" > 0.4 * 20 mm Vermont Slate Textured finish solid <
    /option> <
    option value = "6" > 1 * 20 mm Vermont Slate Textured finish solid <
    /option> <
    option value = "7" > 0.4 * 20 mm Terra NovaTextured finish wood <
    /option> <
    option value = "8" > 1 * 20 mm Terra NovaTextured finish wood <
    /option> <
    option value = "9" > 0.4 * 20 mm Sahara Textured finish wood <
    /option> <
    option value = "10" > 1 * 20 mm Sahara Textured finish wood <
    /option> <
    option value = "12" > 0.4 * 20 mm Nordic Ice Textured finish wood <
    /option> <
    option value = "13" > 1 * 20 mm Nordic Ice Textured finish wood <
    /option> <
    option value = "14" > 0.4 * 20 mm Aged Stone Textured finish wood <
    /option> <
    option value = "15" > 1 * 20 mm Aged Stone Textured finish wood <
    /option> <
    option value = "16" > 0.4 * 20 mm Cascade Textured finish wood <
    /option> <
    option value = "17" > 1 * 20 mm Cascade Textured finish wood <
    /option> <
    option value = "18" > 0.4 * 20 mm Mozambique Wenge Textured finish wood <
    /option> <
    option value = "19" > 1 * 20 mm Mozambique Wenge Textured finish wood <
    /option> <
    option value = "20" > 0.4 * 20 mm FOLKSTONE GREY solid <
    /option> <
    option value = "21" > 1 * 20 mm FOLKSTONE GREY solid <
    /option> <
    option value = "22" > 0.4 * 20 mm LANZA OAK wood <
    /option> <
    option value = "23" > 1 * 20 mm LANZA OAK wood <
    /option> <
    option value = "23" > 0.4 * 20 mm LARACINA wood <
    /option> <
    option > 1 * 20 mm LARACINA wood <
    /option> <
    option > 0.4 * 20 mm WENGE wood <
    /option> <
    option > 1 * 20 mm WENGE wood <
    /option> <
    option > 0.4 * 20 mm CONGO solid <
    /option> <
    option > 1 * 20 mm CONGO solid <
    /option> <
    option > 1 * 20 mm CONGO solid high gloss <
    /option> <
    option > 0.4 * 20 mm COIMBRA wood <
    /option> <
    option > 1 * 20 mm COIMBRA wood <
    /option> <
    option > 1 * 20 mm COIMBRA wood high gloss <
    /option> <
    option > 0.4 * 20 mm CADBURY OAK wood <
    /option> <
    option > 1 * 20 mm CADBURY OAK wood <
    /option> <
    option > 0.4 * 20 mm NORWEGIAN BIRCH wood <
    /option> <
    option > 1 * 20 mm NORWEGIAN BIRCH wood <
    /option> <
    option > 0.4 * 20 mm STORM GREY solid <
    /option> <
    option > 1 * 20 mm STORM GREY solid <
    /option> <
    option > 1 * 20 mm STORM GREY solid high gloss <
    /option> <
    option > 0.4 * 20 mm ROYAL MAHOG wood <
    /option> <
    option > 1 * 20 mm ROYAL MAHOG wood <
    /option> <
    option > 0.4 * 20 mm BALSA wood <
    /option> <
    option > 1 * 20 mm BALSA wood <
    /option> <
    option > 0.4 * 20 mm ESPERANZA OAK wood <
    /option> <
    option > 1 * 20 mm ESPERANZA OAK wood <
    /option> <
    option > 0.4 * 20 mm BURGANDY MOHOGANY wood <
    /option> <
    option > 1 * 20 mm BURGANDY MOHOGANY wood <
    /option> <
    option > 0.4 * 20 mm LUNAR ASH wood <
    /option> <
    option > 1 * 20 mm LUNAR ASH wood <
    /option> <
    option > 1 * 20 mm LUNAR ASH wood high gloss <
    /option> <
    option > 0.4 * 20 mm GLACIER wood <
    /option> <
    option > 1 * 20 mm GLACIER wood <
    /option> <
    option > 0.4 * 20 mm CHERRY ROYAL wood <
    /option> <
    option > 1 * 20 mm CHERRY ROYAL wood <
    /option> <
    option > 1 * 20 mm CHERRY ROYAL wood high gloss <
    /option> <
    option > 0.4 * 20 mm CREAM wood <
    /option> <
    option > 1 * 20 mm CREAM wood <
    /option> <
    option > 1 * 20 mm CREAM wood high gloss <
    /option> <
    option > 0.4 * 20 mm WASHED SHALE wood <
    /option> <
    option > 1 * 20 mm WASHED SHALE wood <
    /option> <
    option > 1 * 20 mm WASHED SHALE wood high gloss <
    /option> <
    option > 0.4 * 20 mm BLACK CHERRY wood <
    /option> <
    option > 1 * 20 mm BLACK CHERRY wood <
    /option> <
    option > 0.4 * 20 mm WERZASCA OAK wood <
    /option> <
    option > 1 * 20 mm WERZASCA OAK wood <
    /option> <
    option > 0.4 * 20 mm BLACK solid <
    /option> <
    option > 1 * 20 mm BLACK solid <
    /option> <
    option > 1 * 20 mm BLACK solid high gloss <
    /option> <
    option > 0.4 * 20 mm SYMPHONY wood <
    /option> <
    option > 1 * 20 mm SYMPHONY wood <
    /option> <
    option > 0.4 * 20 mm WHITE solid <
    /option> <
    option > 1 * 20 mm WHITE solid <
    /option> <
    option > 1 * 20 mm WHITE solid high gloss <
    /option> <
    option > 0.4 * 20 mm Aluminium solid <
    /option> <
    option > 1 * 20 mm Aluminium solid <
    /option> <
    option > 0.4 * 20 mm Cappuccino Linear solid <
    /option> <
    option > 1 * 20 mm Cappuccino Linear solid <
    /option> <
    option > 0.4 * 20 mm Espresso Linear solid <
    /option> <
    option > 1 * 20 mm Espresso Linear solid <
    /option> <
    option > 0.4 * 20 mm Monument Oak Wood <
    /option> <
    option > 1 * 20 mm Monument Oak wood <
    /option> <
    option > 1 * 20 mm Monument Oak wood high gloss <
    /option> <
    option > 0.4 * 20 mm Natural Oak wood <
    /option> <
    option > 1 * 20 mm Natural Oak wood <
    /option> <
    option > 0.4 * 20 mm Shale Oak wood <
    /option> <
    option > 1 * 20 mm Shale Oak wood <
    /option> <
    option > 1 * 20 mm Vancover Maple wood <
    /option> <
    option > 1 * 20 mm BEIGE LINNEN wood high gloss <
    /option> <
    option > 1 * 20 mm WHITE LINNEN wood high gloss <
    /option> <
    /optgroup>
    ...
    th class = "column1"
    id = "column"
    name = "columnHeading" > Index < /th> <
    th class = "column2"
    id = "column" > Board Color < /th> <
    th class = "column3"
    id = "column" > Length < br > (mm) < /th> <
    th class = "column4"
    id = "column" > Width < br > (mm) < /th> <
    th class = "column5"
    id = "column" > Quantity < /th> <
    th class = "column11"
    id = "column" > Grain < /th> <
    th class = "column6"
    id = "column" > Edge < br > Length < br > < /th> <
    th class = "column7"
    id = "column" > Edge < br > Width < br > < /th> <
    th class = "column10"
    id = "column" > Potholes < /th> <
    th class = "column8"
    id = "column" > Edge Material < br > (mm) < /th> <
    /tr> <
    /thead> <
    tbody >
    ...
    <
    td class = "column2"
    id = "column" > < span class = "example" > Iceland White < /span> <
    /td> <
    td class = "column3"
    id = "column" > < span class = "example" > 1200 < /span></td >
    <
    td class = "column4"
    id = "column" > < span class = "example" > 1040 < /span></td >
    <
    td class = "column5"
    id = "column" > < span class = "example" > 1250 < /span></td >
    <
    td class = "column5"
    id = "column" > < span class = "example" > No Grain < /span></td >
    <
    td class = "column6"
    id = "column" > < span class = "example" > 2 < /span></td >
    <
    td class = "column7"
    id = "column" > < span class = "example" > 1 < /span></td >
    <
    td class = "column10"
    id = "column" > < span class = "example" > 4 < /span></td >
    <
    td class = "column8"
    id = "column" > < span class = "example" > 0.4 < /span></td >
    ...
    <
    td class = "column3"
    id = "column" > < span class = "example" > 1280 < /span></td >
    <
    td class = "column4"
    id = "column" > < span class = "example" > 1460 < /span></td >
    <
    td class = "column5"
    id = "column" > < span class = "example" > 6 < /span></td >
    ...
    id = "column" >
    <
    select name = "masonite-colour21"
    class = "masonite-select"
    id = "masonite-select" >
    <
    ...
    <
    p >
    Please note that by submitting this form,
    you confirm that all information provided by you
    is correct.
