...
$dotenv = Dotenv\Dotenv::createMutable(__DIR__, 'HDSGroup');
$dotenv->load();
$DisplayForm = True;
...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['cellphone'])) {
    ...
    if ($mail->addReplyTo($_POST['email'], $_POST['name'])) {
        $mail->Subject = 'Customer Measurements';
        $mail->isHTML(true);
        $mail->Body =  '<span><strong>
        Company:  ' . $_POST['name'] . '<br><br>' .
        'Email:  ' . $_POST['email'] . '<br><br>' .
        'Cellphone: ' . $_POST['cellphone'] . '<br><br>' .
        'Work Number: ' . $_POST['work-number'] . '<br><br>' .
        'Home Number: ' . $_POST['home-number'] . '<br><br>' .
        'Message: '. '<br><br>' . nl2br($_POST['message']) . '<br><br>'.'
        </strong></span>';

        if ($_POST['branch'] == 'Church Street') {
            $mail->addAttachment('thisFile.csv');
            // $mail->addAddress('sales@hds.co.za');
            $mail->addAddress('samora.sm.sam@gmail.com');
    ...
    // $mail->addAddress('sales@hdshammanskraal.co.za');

} else if ($_POST['branch'] == 'Krugersdorp') {
    $mail->addAttachment('thisFile.csv');
    // $mail->addAddress('samora.sm.sam@gmail.com');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdskrugerdorp.co.za');

} else if ($_POST['branch'] == 'Kya Sands') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdskyasand.co.za');

} else if ($_POST['branch'] == 'Johannesburg') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsjohannesburg.co.za');

} else if ($_POST['branch'] == 'Silverton') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdssilverton.co.za');

} else if ($_POST['branch'] == 'Soweto') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdssoweto.co.za');

} else if ($_POST['branch'] == 'Springs') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdssprings.co.za');

} else if ($_POST['branch'] == 'Sunderland') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdssunderland.co.za');

} else if ($_POST['branch'] == 'Tembisa') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdstembisa.co.za');

} else if ($_POST['branch'] == 'Vanderbijlpark') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsvanderbijlpark.co.za');

} else if ($_POST['branch'] == 'Waltloo') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress(' sales@hdswaltloo.co.za');

} else if ($_POST['branch'] == 'Wynberg') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdswynberg.co.za');

} else if ($_POST['branch'] == 'Bloemfontein') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsbloem.co.za');

} else if ($_POST['branch'] == 'Empangeni') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsempangeni.co.za');

} else if ($_POST['branch'] == 'Ladysmith') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsladysmith.co.za');

} else if ($_POST['branch'] == 'Newcastle') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsnewcastle.co.za');

} else if ($_POST['branch'] == 'PMB') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdspmb.co.za');

} else if ($_POST['branch'] == 'PMB Express ') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdspmbx.co.za');

} else if ($_POST['branch'] == 'South Coast') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdssouthcoast.co.za');

} else if ($_POST['branch'] == 'Burgersfort') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsburgersfort.co.za');

} else if ($_POST['branch'] == 'Bela-Bela') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsbelaela.co.za');

} else if ($_POST['branch'] == 'Ermelo') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsermelo.co.za');

} else if ($_POST['branch'] == 'Nelspruit') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsnelspruit.co.za');

} else if ($_POST['branch'] == 'Trichardt') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdstrichardt.co.za');

} else if ($_POST['branch'] == 'Witbank') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdswitbank.co.za');

} else if ($_POST['branch'] == 'Brits') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsbrits.co.za');

} else if ($_POST['branch'] == 'Klerksdorp') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsklerksdorp.co.za');

} else if ($_POST['branch'] == 'Mafikeng') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsmafikeng.co.za');

} else if ($_POST['branch'] == 'Marula') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdsmarula.co.za');

} else if ($_POST['branch'] == 'Kimberly') {
    $mail->addAttachment('thisFile.csv');
    $mail->addAddress('sales@hds.co.za');
    // $mail->addAddress('sales@hdskimberly.co.za');
}
        ...
        <div class="wrapper wrapper--w680" id="wrapper">
            <div class="card card-1" id="card card-1">
                <div class="card-body" id="card-body">
                    ...
                    <form name="form" class="form" id="form" method="POST" action="mail.php">
                            ...
                            <div class="col-2">
                                <div id="input-group" class="input-group">
                                    <input id="input--style-1" class="input--style-1 work-number" type="text"
                                        placeholder="Work Number (Optional)" id="work-number" name="work-number">
                                </div>
                                <p class="error"></p>
                            </div>
                            <div class="col-2">
                                <div id="input-group" class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input id="input--style-1" class="input--style-1 home-number" type="text"
                                            id="home-number" placeholder="Home Number (Optional)" name="home-number">
                                    </div>
                                </div>
                                <p class="error"></p>
                        ...
                        <div class="wrap-input100 validate-input" id="wrap-input100"
                            ...
                            <textarea class="input100" name="message" id="input100"
                        ...
                        <button type="submit" id="sendbutton" class="sendbutton">Send</button>
...
?><?php /**PATH C:\xampp1\htdocs\HDSGroup\resources\views/pages/mail.blade.php ENDPATH**/ ?>